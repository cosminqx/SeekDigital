      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8 lg:pb-40">
        ...
        <RevealSection className="mt-20">
          ...
          <div className="mt-10 max-w-3xl">
            <Accordion type="single" collapsible className="border-t border-[#1f1f1f]">
              {pricingFaq.map((item) => (
        ...
        <RevealSection className="mt-16 flex justify-center">
          <Link href="/contact" className="text-sm font-medium uppercase tracking-[0.24em] text-accent transition hover:text-white">
