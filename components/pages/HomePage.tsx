  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-[#222222]">
        ...
        />
        <motion.div
          className="mesh-blob mesh-blob-delay absolute right-0 top-24 h-80 w-80 rounded-full bg-white/5 blur-3xl"
          animate={{ x: [0, -22, 18, 0], y: [0, 20, -16, 0] }}
          transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="mesh-blob mesh-blob-delay-2 absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-emerald-400/10 blur-3xl"
      ...
      <section className="bg-accent px-4 py-24 text-black sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl space-y-4">
            <p className="font-display text-xs uppercase tracking-[0.28em] text-black/70">Call to action</p>
