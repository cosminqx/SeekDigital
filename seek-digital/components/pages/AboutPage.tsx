    ...
    <div className="border-b border-[#1f1f1f]">
      <RevealSection className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[220px_1fr] lg:items-center">
          <div className="mx-auto flex h-[200px] w-[200px] items-center justify-center overflow-hidden rounded-full border border-[#1f1f1f] bg-card">
          ...
          <div className="space-y-5">
            <div>
              <h2 className="font-display text-3xl font-bold uppercase tracking-[-0.03em] text-white sm:text-4xl">
                Silviu Chiscareanu
              </h2>
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-4">
          {milestones.map((milestone, index) => (
            <Card key={milestone.label} className="p-6">
              <div className="flex h-10 w-10 items-center justify-center rounded-full border border-accent bg-accent text-sm font-semibold text-black">
                {index + 1}
              </div>
              <p className="mt-6 font-display text-xl font-bold uppercase tracking-[-0.03em] text-white">{milestone.label}</p>
      ...
      <RevealSection className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8 lg:pb-40">
        <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          <Card className="p-8">
            ...
            <h3 className="mt-4 font-display text-3xl font-bold uppercase tracking-[-0.03em] text-white">
              {siteConfig.company}
            </h3>
